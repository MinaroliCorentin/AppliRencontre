 ...
 */
final class Version20260205075041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, mdp VARCHAR(40) NOT NULL, image_identite VARCHAR(50) DEFAULT NULL, accord_gdpr TINYINT NOT NULL, is_modo TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
